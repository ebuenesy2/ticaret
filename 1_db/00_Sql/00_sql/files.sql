...
-- Üretim Zamanı: 11 Tem 2023, 14:27:19
...
CREATE TABLE `files` (
  ...
  `fileWhere` text COLLATE utf8mb4_general_ci NOT NULL,
  `fileName` text COLLATE utf8mb4_general_ci,
  `fileExt` text COLLATE utf8mb4_general_ci,
  `fileType` text COLLATE utf8mb4_general_ci,
  `fileOriginalName` text COLLATE utf8mb4_general_ci NOT NULL,
  `fileUploadUrl` text COLLATE utf8mb4_general_ci NOT NULL,
  `sizeByte` text COLLATE utf8mb4_general_ci NOT NULL,
  `sizeTotal` text COLLATE utf8mb4_general_ci NOT NULL,
  `sizeTotalType` text COLLATE utf8mb4_general_ci NOT NULL,
