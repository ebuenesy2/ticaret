...
<body>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" id="stockAdd" data_sector="" data_sub_sector=""  data_stock_id="" >
                                                    ...
                                                    @for ($i = 0; $i < count($DB_Find_requestform_product_list); $i++) 
                                                    <option value="{{$DB_Find_requestform_product_list[$i]->id}}" id="stockAddOption" data_sub_sector="{{$DB_Find_requestform_product_list[$i]->sub_sector }}" > {{$DB_Find_requestform_product_list[$i]->nameTr }} </option>
                                                    @endfor                          
                                                </select>
                                            </div>
                                            <!--Stok Son -->
                        ...
                        <form action="#">
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-12">
                                       <div class="mb-3"> 
                                            <label for="cal_titleAdd" class="form-label">Başlık</label>
                                            <input class="form-control" type="text" id="cal_titleAdd" name="cal_titleAdd" >
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="mb-3">
                                            <label for="cal_CurrencyAdd" class="form-label">@lang('admin.Currency')</label>
                                            <select class="form-control"  name="choices-single-default2" id="cal_CurrencyAdd"  disabled >
                                    ...
                                    <div class="col-6">
                                        <div class="mb-3"> 
                                            <label for="cal_CurrencyRateAdd" class="form-label">@lang('admin.CurrencyRate')</label>
                                            <input class="form-control" type="text" id="cal_CurrencyRateAdd" name="cal_CurrencyRateAdd" placeholder="@lang('admin.CurrencyRate')"  value="{{$currencyPrice}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="/get/offers/list">Teklif Formu Listesi</a></li>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card">
                        <div class="card-header" style="background-color: rgb(197, 120, 92);">
                            <h5 class="card-title mb-0" style="color:white">Ürün Tanıma</h5>
                        </div>
                        <div class="card-body">
                           <div class="row">
                                <div class="col-8 mb-3">
                                    <label class="form-label" for="title">Başlık</label>
                                    <input type="text" class="form-control" id="title" placeholder="" value="{{$DB_Find->title}}" >
                                </div>
                                 <!-- Para Birimi -->
                                 <div class="col-4 mb-3">
                                    <label for="SelectProductCurrencyAdd" class="form-label">Para Birimi</label>
                                    <select class="form-control" data-choices="" data-choices-search-false="" name="choices-single-default2" id="SelectProductCurrencyAdd" style="cursor: pointer;" disabled>
                    ...
                    <div class="card">
                        <div class="card-header" style="background-color:rgb(212, 212, 212);">
                            <h5 class="card-title mb-0">TEKLİF EDİLEN ÜRÜN FİYAT LİSTESİ</h5>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control"  name="choices-single-default2" id="intertekAdd">
                                            <option value="" selected>Seç</option>
                                            @for ($i = 0; $i < count($DB_Find_intertekTabi); $i++) <option value="{{$DB_Find_intertekTabi[$i]->id}}" data_title="{{$DB_Find_intertekTabi[$i]->title}}" {{$DB_Find->intertek == $DB_Find_intertekTabi[$i]->id ? 'selected' : ''   }} >{{$DB_Find_intertekTabi[$i]->title}}</option> @endfor
                                        </select>
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        <label for="deliveryLocation" class="form-label">Teslim Yeri </label>
                                    ...
                                    <div class="mb-3">
                                        <label for="specialPermitAdd" class="form-label">Özel İzin ( Varsa )
                   ...
                   <div class="card">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="selectRequestEdit" disabled>
                                  ...
                                  @for ($i = 0; $i < count($DB_Find_requestform); $i++) <option value="{{$DB_Find_requestform[$i]->id}}"  {{$DB_Find->requestformid == $DB_Find_requestform[$i]->id ? 'selected' : '' }} >{{$DB_Find_requestform[$i]->requestFormTitle}}</option>  @endfor                            
                                </select>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-header" style="background-color:rgb(180, 83, 159);">
                            <h5 class="card-title mb-0" style="color:white">TEKLİF VEREN FİRMA BİLGİSİ</h5>
                        </div>
                        <div class="card-body">
                            <div class="mb-3">
    ...
    <footer>
        ...
        @include('admin.include.footer')
         ...
         <!------- List --->
         <script src="{{asset('/assets/admin')}}/js/getOffers/getOffersActions.js"></script>
