...
<head>
    ...
    <meta charset="utf-8" />
    <title> @lang('admin.FileUpload') | {{ config('admin.Admin_Title') }}</title>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">@lang('admin.FileUpload')</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="/sabit/@lang('admin.lang')">@lang('admin.File')</a></li>
                                <li class="breadcrumb-item active">@lang('admin.FileUpload')</li>
                            </ol>
                        </div>
