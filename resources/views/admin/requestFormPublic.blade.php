...
<head>
    ...
    <meta charset="utf-8" />
    <title> public - @lang('admin.RequestReceiveForm')  - @lang('admin.Update') #{{$DB_Find->id}}  | {{ config('admin.Admin_Title') }}</title>
                        ...
                        <form action="#">
                            ...
                            <div class="modal-footer">
                                <div class="hstack gap-2 justify-content-end">
                                    ...
                                    @if($DB_Find->public == "1")  <button type="button" class="btn btn-info" id="data_productUpdate"  >@lang('admin.Update')</button> @endif
                                </div>
                            </div>
                        </form>
                    </div>
