...
<head>
    ...
    <meta charset="utf-8" />
    <title> @lang('admin.Example') | {{ config('admin.Admin_Title') }}</title>
...
<body>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">@lang('admin.Example')</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="/sabit/@lang('admin.lang')">@lang('admin.Example')</a></li>
                                <li class="breadcrumb-item active">@lang('admin.Example')</li>
                            </ol>
                        </div>
    ...
    <footer>
        ...
        <!------- Footer --->
        <script src="{{asset('/assets/admin')}}/js/4_example.js"></script>
