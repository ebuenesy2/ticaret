...
<head>
    ...
    <meta charset="utf-8" />
    <title>Sabit | {{ config('admin.Admin_Title') }}</title>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Empty</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="/admin/xx">Pages</a></li>
                ...
                <div class="col-12">
                    <div class="d-flex flex-column gap-2">
                        <h4 class="mb-sm-0">Admin Anasayfa </h4>
