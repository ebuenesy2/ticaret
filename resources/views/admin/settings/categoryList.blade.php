...
<head>
    ...
    <meta charset="utf-8" />
    <title> @lang('admin.Category') @lang('admin.List') | {{ config('admin.Admin_Title') }}</title>
                    ...
                    <div class="modal-body">
                        <div class="row">
                           <div class="col-12">
                                <!-- Arama Durum -->
                                <div class="mb-3">
                                    <label for="selectTypeAdd" class="form-label">Tür</label>
                                    <select class="form-control" data-choices data-choices-search-false name="choices-single-default2" id="selectTypeAdd">
                                        <option value="" selected >Tür Seç</option>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3"> 
                                    ...
                                    <input class="form-control" type="text" id="titleAdd" name="titleAdd" >
                                </div>
                                <div class="mb-3"> 
                            ...
                            <div class="col-6">
                                <div class="mb-3"> 
                                    <label for="titleEnAdd" class="form-label">Başlık EN</label>
                                    <input class="form-control" type="text" id="titleEnAdd" name="titleEnAdd" >
                                </div>
                                <div class="mb-3"> 
   ...
   <div class="page-content">
     <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">@lang('admin.Category') @lang('admin.List') </h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="/category/list">@lang('admin.Category') @lang('admin.List')</a></li>
        ...
        <footer>
            ...
            <!------- List --->
            <script src="{{asset('/assets/admin')}}/js/settings/categoryList.js"></script>
