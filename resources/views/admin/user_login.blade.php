                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4 auth-one-bg h-100">
                                        ...
                                        <div class="position-relative h-100 d-flex flex-column">
                                            ...
                                            <div class="mt-auto">
                                                <div id="qoutescarouselIndicators" class="carousel slide" data-bs-ride="carousel"></div>
                                                <!-- end carousel -->
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        <div>
                                            ...
                                            <p class="text-muted"> @lang('admin.loginPanel') </p>
                                        </div>
                                        ...
                                        <div class="mt-4">
                                            <form action="{{route('user.login.control')}}" method="post" class="c-card__body" >
