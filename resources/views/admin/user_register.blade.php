...
<head>
    ...
    <meta charset="utf-8" />
    <title> @lang('admin.register') | {{ config('admin.Admin_Title') }}</title>
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        <div>
                                            <h5 class="text-primary">@lang('admin.userRegistrationPanel')</h5>
                                        </div>
                                        ...
                                        <div class="mt-4">
                                            <form action="{{route('user.register.control')}}" method="post" class="c-card__body" >
                                                ...
                                                <div class="mb-3">
                                                    <label for="dateofBirth" class="form-label">@lang('admin.dateOfBirth')</label>
                                                    <input class="form-control"  id="dateofBirth" name="dateofBirth" type="date"  data-date-format="DD/MM/YYYY" value="2000-01-01">
                                                </div>
                                             
                                                <div class="mb-3">
                                                    <label for="email" class="form-label">@lang('admin.email')</label>
                                                    <input class="form-control" type="email" id="email" name="email" placeholder="info@email.com">
                                                </div>
                                                ...
                                                <div class="mt-4">
                                                    <button class="btn btn-success w-100" type="submit">@lang('admin.register')</button>
                                                </div>
                                        ...
                                        <div class="mt-5 text-center">
                                            <p class="mb-0"> <a href="/user/login/{{__('admin.lang')}}" class="fw-semibold text-primary text-decoration-underline"> @lang('admin.login')</a> </p>
                                        </div>
                                    </div>
                                </div>
                                <!-- end col -->
