...
-- Üretim Zamanı: 11 Tem 2023, 14:27:59
...
CREATE TABLE `requestform_product_list` (
  ...
  `requestform_id` int DEFAULT NULL,
  `sector` text COLLATE utf8mb4_general_ci,
  `sub_sector` int DEFAULT NULL,
  `stock_id` text COLLATE utf8mb4_general_ci,
...
(79, 3, 'serverToken2', 59, '69', 36, '65', 'TR', 'En', '/assets/img/product/default.jpg', NULL, 'Ton', '10', 'Dolar', '68', '680.00', NULL, NULL, 'false', NULL, NULL, 'Açıklama TR', 'Açıklama EN', 'Özellikler TR', 'Özellikler EN Güncelle', 'Teknik Özellik TR', 'Teknik Özellik EN', 'Ürün Web Sitesi', 'Katalog Linki', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'T53656565', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2023-07-11 06:54:22', 1, 1, '2023-07-11 09:29:58', NULL, 1, 0, NULL, NULL);
